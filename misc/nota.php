...
$pdf->Cell(60,10,'Amigos Wines & Spirits',0,1,'C');

$pdf->Line(10,18,72,18);
$pdf->Line(10,19,72,19);

$pdf->SetFont('Arial','',8);
$pdf->Cell(60,3,'Address: Pipeline Estate, Phase IV, Nairobi',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,3,'Wines,Beers,Whiskeys,Vodkas,Brandys',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,4,'Contact: 0738-492-448 (Sam); edwingichuhis@gmail.com',0,1,'C');
...
$pdf->Cell(60,6 ,'Purchase Order',0,1,'C');

$pdf->SetFont('Courier','B',8);
$pdf->Cell(20,4 ,'Order No.     :',0,0,'C');

$pdf->SetFont('Courier','BI',8);
$pdf->Cell(10,4 ,$row->invoice_id,0,1,'C');

$pdf->SetFont('Courier','B',8);
$pdf->Cell(20,4 ,'Operator Name :',0,0,'C');
...
$pdf->Cell(75,4 ,'Refunds are not accepted without a purchase receipt',0,1,'L');

$pdf->SetFont('Arial','BU',5);
$pdf->Cell(45,4 ,'Returns are accepted a maximum of 24 hours after purchase',0,0,'C');
